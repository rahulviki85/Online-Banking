	...
	static {
		customerOne=new Customer("Rahul","123456781",new Address("Pimpri","Pune","MH"),new Account(new BigInteger("1001"),new BigDecimal(9000),null));
		  ...
		  SimpleDateFormat fmt = new SimpleDateFormat("yyyy-MM-dd");
		   ...
		   try {
			tranOne=new Transaction(new BigInteger("10001"),fmt.parse("2018-12-05"),"For Loan",new BigDecimal(500),new BigDecimal(4000));
			 tranTwo=new Transaction(new BigInteger("10002"),fmt.parse("2018-12-01"),"For Rent",new BigDecimal(100),new BigDecimal(3900));
			    tranThree=new Transaction(new BigInteger("10003"),fmt.parse("2018-11-03"),"DMart",new BigDecimal(400),new BigDecimal(3500));		
